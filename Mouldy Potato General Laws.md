...
**1.15** Any attempts to bribe the administration are forbidden. **| BAN 3+ days** 
...
**2.2** Any form of insults, bullying, racism, discrimination, religious hostility, or sexism is prohibited in chat or voice. **| Timeout 5+ minutes | WARN** 

**2.3** Spamming in non-spam channels is prohibited spamming is considered as 3 or more similar messages that were sent during a time interval shorter than 3 minutes by the same person. **| Timeout 5+ minutes** 

**2.4** Do not use an improperly tuned microphone with excessive volume, background noise, hiss, etc. **| Mute in vc | Timeout 5+ minutes**
